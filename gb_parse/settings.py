...
# числа - приоритет выполнения, чем число ниже, тем выше приоритет
ITEM_PIPELINES = {
...
# подстраивается под сервер который парсим и сам настроит время запроса
